...
- 🏛️ **هوية «المتحف الكلاسيكي»** — ورق عتيق، حبر، ذهبي مطفي، خط Amiri؛ وضع نهار/ليل. أغلفة لوحات من **Met Museum (CC0)** مع استخراج باليتة تلوّن كل صفحة بلون-accent واحد + tint (مُروَّض للتباين).
